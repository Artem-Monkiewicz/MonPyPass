...
if pass_type == 1:
    while True:
        try:
            ...
            if quick_pass > 0:  # Check for a positive number
...
# Custom password
    ...
    while True:
        try:
            ...
            if nr_letters >= 0 and nr_symbols >= 0 and nr_numbers >= 0:  # Check for non-negative numbers
                if nr_letters + nr_symbols + nr_numbers > 0:  # Checking if the sum of elements is greater than 0
